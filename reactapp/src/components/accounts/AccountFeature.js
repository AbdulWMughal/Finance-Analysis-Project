    ...
    return (
        <div style={{marginBottom:10}}>
            <Grid >
                ...
                <Grid.Col span={6} md={"content"}>
                    <Paper  radius="md" miw={"180px"} p="md" withBorder>
                        <Text size={"lg"} fw={700}>{`£. ${handleTotalIncome().toLocaleString("en-US")}`}</Text>
                        <Text size={"sm"} fw={700} c="dimmed">
                            TOTAL INCOME
                        </Text>
                    </Paper>
                ...
                <Grid.Col span={6} md={"content"}>
                    <Paper radius="md" miw={"180px"} p="md" withBorder>
                        <Text size={"lg"} fw={700}>{`£. ${handleTotalExpense().toLocaleString("en-US")}`}</Text>
                        <Text size={"sm"} fw={700} c="dimmed">
                            TOTAL EXPENSES
                        </Text>
                    </Paper>
                ...
                <Grid.Col span={6} md={"content"}>
                    <Paper  radius="md" miw={"180px"} p="md" withBorder>
                        <Text size={"lg"} fw={700} style={{color: "#26AB35"}}>{`£. ${handleTotalBalanace().toLocaleString("en-US")}`}</Text>
                        <Text size={"sm"} fw={700} c="dimmed">
                            TOTAL BALANCE
                        </Text>
                    </Paper>
