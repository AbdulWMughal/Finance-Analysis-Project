                        ...
                        {isMobile ?
                            <div>
                                <Paper style={{marginBottom:10}} radius="md" p="md" withBorder>
                                    <Grid >
                                        <Grid.Col span={12} md={6}>
                                            <Title order={4}>{result?.total_expenses>0 ? `£. ${result?.total_expenses.toLocaleString("en-US")}` : `-`}</Title>
                                ...
                                <Paper  radius="md" p="md" withBorder>
                                    <Grid >
                                        <Grid.Col span={12} md={6}>
                                            <Title style={{color: "#26AB35"}} order={4}>{result?.total_income>0 ? `£. ${result?.total_income.toLocaleString("en-US")}` : `-`}</Title>
